...
Reusable GitHub Actions workflow for building and testing Java applications with Gradle. Provides automated compilation, testing, JaCoCo coverage verification (90% minimum), and artifact generation for downstream workflows.
