# Compute-Next-Tag Action

## Purpose

Composite GitHub Action that calculates the expected next semantic version tag based on Git tag history. Supports configurable version patterns and suffixes, automatically increments patch versions, and handles first-version scenarios.
